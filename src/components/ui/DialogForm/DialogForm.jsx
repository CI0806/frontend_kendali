...
const DialogForm = ({ open, handleClose, data, onConfirm, loading }) => {
    ...
    >
      ...
      <DialogContent sx={{ px: 3, pb: 2 }}>
        ...
        >
          ...
          <DataRow label="Periode Cuti" value={data.periode} />
          <DataRow label="Jenis Cuti" value={data.jenis_cuti} />
          <DataRow label="Lama Cuti" value={`${data.lama_cuti} Hari`} />
          <DataRow label="Alasan" value={data.alasan} />
        </Stack>
